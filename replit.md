...
- July 7, 2025. Fixed critical authentication infinite loop issue after logout. Resolved by disabling aggressive refetching in useAuth hook, improving logout endpoint to properly destroy sessions and clear cookies, updating logout button to use POST endpoint with proper cache clearing, and adding comprehensive error handling. Authentication flow now works smoothly without repeated user deserialization commands or loading loops.